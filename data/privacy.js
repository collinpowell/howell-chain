export const privacy = [
    {
        ...
        text: [
            {
                p: 'At Howrea Network, we take the privacy of our users seriously. This Privacy Policy ("Policy") explains how we collect, use, and disclose information when you use our Platform / Service. By using the Service, you accept the practices outlined in this Policy.'
            }
        ]
    },
    {
        heading: 'Information Collection and Use',
        subHeading: 'When you use the Service, we may collect the following types of information:',
        text: [
            {
                p: 'Personal Information: We may collect personal information such as your name, email address, and phone number when you create an account with us. We may also collect personal information when you use certain features of the Service, such as sending or receiving cryptocurrency.'
            },
            {
                p: 'Device Information: We may collect information about the device you use to access the Service, such as the device type, operating system, and unique device identifiers.'
            },
            {
        ...
        text: [
            {
                ...
                ul: [
                    ...
                    {
                        li: 'Address, Country, State, Province, ZIP/Postal code, City',
                    },
                    {
    ...
    },
    {
        ...
        text: [
            {
                p: 'We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through any device (“Usage Data”).'
            },
            {
    ...
    },
    {
        ...
        text: [
            {
                p: 'We may use and store information about your location if you give us permission to do so (“Location Data”). We use this data to provide features of our Service, to improve and customize our Service.'
            },
            {
    ...
    },
    {
        ...
        text: [
            ...
            {
                p: 'Log Data: We may collect log data when you use the Service, including information about your interactions with the Service, IP address, and browser type.'
            },
            {
                p: 'We use the information we collect to provide and improve the Service, as well as to communicate with you and respond to your inquiries.',
    ...
    },
    {
        ...
        text: [
            {
                p: 'Talent Dev Hub uses the collected data for various purposes:',
                ul: [
                    {
                    ...
                    {
                        li: 'to fulfil any other purpose for which you provide it;',
                    },
                    {
    ...
    },
    {
        ...
        text: [
            ...
            {
                p: 'If you are located outside Nigeria and choose to provide information to us, please note that we transfer the data, including Personal Data, to Nigeria and process it there.'
            },
            {
            ...
            {
                p: 'Talent Dev Hub will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.'
            }
        ]
    },
    {
...

    {
        ...
        text: [
            {
                p: 'If you have any questions about this Privacy Policy, please contact us by email: info@nodexihub.com.'
            }
        ]
    },
]